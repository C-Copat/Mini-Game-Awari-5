...
// creating custom hooks to set maxHp

export function useMaxHp() {
    return useContext(MonsterMaxHpContext) 
}

export function useCurrentHp() {
    return useContext(MonsterCurrentHpContext) 
}
